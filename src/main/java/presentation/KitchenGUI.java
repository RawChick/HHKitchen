...
/**
 * 
 * This class contains the kitchenGUI and creates the ChangeMealGUI, NewMealGUI
 * and the SpecificationGUI.
 * 
...
public class KitchenGUI extends JPanel {
    ...
    private JButton acceptOrder, specificationMeal, ready, newMeal, changeMeal,
            deleteMeal;
    ...
    public void createOrderOverview(JComponent orderOverview) {
        ...
        acceptedOrderList
                .addListSelectionListener(acceptedOrderSelectionListener);
    ...
    public void fillLists() {
        ...
        for (Order order : orders) {
            if (order.getStatus() == 1) {
                ...
                acceptedOrderListModel.addElement("Bestelnr: "
                        + order.getOrderNr());
            }
        }
    }
    ...
    public void createMealManaging(JComponent mealManaging) {
        ...
        managingMealList
                .addListSelectionListener(managingMealListSelectionListener);
        fillProductLists();
    ...
    public void fillProductLists() {
        ...
        for (Product product : products) {
            managingMealListModel.addElement(String.format("%02d",
    ...
    public void setButtonEnabled() {
        ...
        if (!newOrderList.isSelectionEmpty()) {
            ...
            String nr = selectedOrder
                    .substring(selectedOrder.lastIndexOf(' ') + 1);
        ...
        if (!acceptedOrderList.isSelectionEmpty()) {
            ...
            String selectedOrder = (String) acceptedOrderList
                    .getSelectedValue();
            String nr = selectedOrder
                    .substring(selectedOrder.lastIndexOf(' ') + 1);
        ...
        public void valueChanged(ListSelectionEvent e) {
            if (e.getValueIsAdjusting() == false) {
                ...
                if (selectedOrder != null) {
                    String nr = selectedOrder.substring(selectedOrder
                            .lastIndexOf(' ') + 1);

                    int orderNr = Integer.parseInt(nr);

                    List<OrderRow> orderRowsProducts = manager
                            .getProducts(orderNr);
